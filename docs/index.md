...
The source code can be found [here](https://github.com/Deltares/MeshKernelPy) and the underlying C++ library `MeshKernel` found [here](https://github.com/Deltares/MeshKernel).
...
![](images/TriangularMeshInPolygon.jpg)
...
![](images/MeshOrthogonalization.jpg)

3. Mesh refinement

A mesh can be refined in areas based on samples or polygon selections. 

![](images/GridRefinement.jpg)
