...
class build_ext(build_ext_orig):
    ...
    def build_cmake(self, ext):
        ...
        self.spawn(["git", "-C", "./MeshKernelTest", "branch"])
...
setup(
    ...
    url="https://github.com/Deltares-research/MeshKernelPyTest",
    license="MIT",
    ...
    ext_modules=[CMakeExtension("https://github.com/Deltares-research/MeshKernelTest")],
