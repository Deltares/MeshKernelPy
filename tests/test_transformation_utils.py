...
def test_rotate_point():
    ...
    origin = [0.0, 0.0]
    angle = -30.0
    point_rotated = tests.transformation_utils.rotate(point, origin, angle)
...
def test_translate_point():
    ...
    point = [1.0, 2.0]
    translation = [3.0, 4.0]
    point_translated = tests.transformation_utils.translate(point, translation)
...
def test_translate_points():
    ...
    translation = [3.0, 4.0]
    translated_point_x, translated_point_y = tests.transformation_utils.translate(
